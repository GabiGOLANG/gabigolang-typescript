...
const keywords = new Map<string, TokenType>([
  ["OSCORINGA", TokenType.AND],
  ["FLAMENGO", TokenType.OR],
  ["COMPRAR", TokenType.MOD],
  ["TRAVE", TokenType.ELSE],
  ["JUIZ", TokenType.FALSE],
  ...
  ["APITO", TokenType.THIS],
  ["VAR", TokenType.TRUE],
  ["GOLDOFLAMENGO", TokenType.LET],
  ["MARACANA", TokenType.CONST],
  ["LIBERTA", TokenType.WHILE],
  ["IMPERADOR", TokenType.CLASS],
  ["SERIEB", TokenType.CLASS_EXTENDS],
  ["TROPADOJJ", TokenType.STATIC]
])
